...
class wpex_port_posts_thumb_widget extends WP_Widget {
    /** constructor */
    function wpex_port_posts_thumb_widget() {
        parent::WP_Widget(false, $name = __('Portfolio Posts w/ Thumbs','wpex'), array( 'description' => __( 'Display a list of recent standard posts with featured thumbnails.', 'wpex' ) ) );
    }
...
} // class wpex_port_posts_thumb_widget
