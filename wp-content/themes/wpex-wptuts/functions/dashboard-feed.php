<?php
/**
 * Creates a WPExplorer dashboard feed
 *
 * @package WordPress
...
function rc_mdm_register_widgets() {
	...
	wp_add_dashboard_widget('widget_wpexplorer_feed', __('WordPress Articles', 'rc_mdm'), 'wpex_dashboard_rss_box');
	wp_add_dashboard_widget('widget_wdexplorer_feed', __('Web Design Articles', 'rc_mdm'), 'wde_dashboard_rss_box');
}
