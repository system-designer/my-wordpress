...
if ( ! function_exists( 'wpex_post_meta' ) ) {
	...
	function wpex_post_meta() {
		...
		<ul class="post-meta clr">
			<li class="meta-date">
				<i class="fa fa-clock-o"></i><span class="meta-date-text"><?php echo get_the_date(); ?></span>
			</li>
			<?php if(isset($fist_category)){ ?>
				<li class="meta-category">
					<i class="fa fa-folder-o"></i><a href="<?php echo $category_url; ?>" title="<?php echo $category_name; ?>"><?php echo $category_name; ?></a>
				</li>
			<?php } ?>
			<?php if( comments_open( $post_id ) ) { ?>
				<li class="meta-comments comment-scroll">
					<i class="fa fa-comments-o"></i><?php comments_popup_link( __( '0 Comments', 'wpex' ), __( '1 Comment',  'wpex' ), __( '% Comments', 'wpex' ), 'comments-link' ); ?>
				</li>
			<?php } ?>
		</ul><!-- .post-meta -->
