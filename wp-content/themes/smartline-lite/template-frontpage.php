	...
	<div id="wrap" class="clearfix template-frontpage">
		...
		<?php // Display Description about FrontPage Widgets when widget area is empty
			...
			<p class="frontpage-magazine-no-widgets">
				<?php _e('There are no widgets to be displayed. Please go to Appearance → Widgets and add at least one widget to the "Magazine Front Page" widget area. You can use the three Category Posts widgets to set up the theme like the demo website.', 'smartline-lite'); ?>
			</p>
